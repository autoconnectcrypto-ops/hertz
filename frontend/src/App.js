...
// Admin Documents Page - Protégée par mot de passe
      ...
      <div data-testid="admin-login-page">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-md mx-auto px-6">
            <form onSubmit={handleLogin} className="bg-[#F5F5F5] p-8">
              <h2 className="text-xl font-bold mb-6 text-center text-[#0A0A0A]" style={{fontFamily: 'Oswald, sans-serif'}}>
                Connexion requise
              </h2>
              <input
                type="password"
                ...
                className="w-full p-4 border border-[#ddd] mb-4 focus:border-[#FFD100] outline-none"
              />
              {error && <p className="text-red-500 text-sm mb-4">{error}</p>}
              <button
                type="submit"
                className="w-full bg-[#0A0A0A] text-white font-semibold uppercase tracking-wider py-4 hover:bg-[#FFD100] hover:text-black transition-colors"
              >
                Accéder
              </button>
            </form>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <p className="text-[#666] mb-8 text-center">
            Cliquez sur un document pour l'ouvrir. Vous pouvez ensuite le remplir et l'imprimer en PDF.
          </p>
